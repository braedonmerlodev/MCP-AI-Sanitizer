...
class TestAPIEndpoints:
    ...
    def test_process_pdf_invalid_file_type(self, mock_validate, mock_auth, mock_rate_limit):
    ...
    def test_process_pdf_no_text_extracted(self, mock_extract, mock_validate, mock_auth, mock_rate_limit):
    ...
    def test_process_pdf_sanitize_tool_not_found(self, mock_get_agent, mock_extract, mock_validate, mock_auth, mock_rate_limit):
    ...
    @patch('backend.api.extract_pdf_text')
    @patch('backend.api.get_agent')
    def test_process_pdf_sanitize_failed(self, mock_get_agent, mock_extract, mock_validate, mock_auth, mock_rate_limit):
        ...
        mock_sanitize_tool.function = AsyncMock(return_value={"success": False, "error": "Sanitize failed"})
    ...
    @patch('backend.api.extract_pdf_text')
    @patch('backend.api.get_agent')
    def test_process_pdf_enhance_tool_not_found(self, mock_get_agent, mock_extract, mock_validate, mock_auth, mock_rate_limit):
        ...
        mock_sanitize_tool = MagicMock()
        mock_sanitize_tool.name = "sanitize_content"
        mock_sanitize_tool.function = AsyncMock(return_value={"success": True, "sanitized_content": "sanitized text"})
        mock_agent.tools = [mock_sanitize_tool]
        mock_get_agent.return_value = mock_agent
    ...
    @patch('backend.api.extract_pdf_text')
    @patch('backend.api.get_agent')
    def test_process_pdf_success(self, mock_get_agent, mock_extract, mock_validate, mock_auth, mock_rate_limit):
    ...
    def test_sanitize_json_endpoint_validation(self):
        ...
        response = self.client.post("/api/sanitize/json", json={"content": long_content})
        assert response.status_code == 422
