    ...
    *,
    ...
    def decorator(
        ...
        func_can_jump_to = (
            can_jump_to
            if can_jump_to is not None
            else getattr(func, "__can_jump_to__", [])
        )
    ...
    *,
    ...
    def decorator(
        ...
        if is_async:
            ...
            middleware_name = name or cast(
                "str", getattr(func, "__name__", "AfterModelMiddleware")
            )
    ...
    *,
    ...
    def decorator(
        ...
        if is_async:
            ...
            middleware_name = name or cast(
                "str", getattr(func, "__name__", "AfterAgentMiddleware")
            )
...
def dynamic_prompt(
    ...
    def decorator(
        ...
        def wrapped(
            ...
            prompt = cast("Callable[[ModelRequest], SystemMessage | str]", func)(
                request
            )
            if isinstance(prompt, SystemMessage):
                request = request.override(system_message=prompt)
