            ...
            if omit_flag:
                ...
                for meta in metadata:
                    if (
                        ...
                        and getattr(meta, omit_flag) is True
                    ):
                        should_omit = True
                        break
...
def create_agent(  # noqa: PLR0915
    ...
    *,
    ...
    # validate middleware
    assert len({m.name for m in middleware}) == len(
        middleware
    ), "Please remove duplicate middleware instances."  # noqa: S101
        ...
        if (
            ...
            if structured_tool_calls:
                ...
                try:
                    ...
                    structured_response = structured_tool_binding.parse(
                        tool_call["args"]
                    )
