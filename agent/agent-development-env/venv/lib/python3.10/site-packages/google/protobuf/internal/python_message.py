...
def _IsMapField(field):
    return (
        field.type == _FieldDescriptor.TYPE_MESSAGE and field.message_type._is_map_entry
    )
...
def _AttachFieldHelpers(cls, field_descriptor):
    ...
    AddFieldByTag(type_checkers.FIELD_TYPE_TO_WIRE_TYPE[field_descriptor.type], False)
...
def _AddEqualsMethod(message_descriptor, cls):
    ...
    def __eq__(self, other):
        ...
        if self.DESCRIPTOR.full_name == _StructFullTypeName and isinstance(other, dict):
            return self._internal_compare(other)
