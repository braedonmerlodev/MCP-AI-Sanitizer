...
class FileServiceClient(metaclass=FileServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ai.generativelanguage_v1beta.FileServiceClient`.",
                    extra=(
                        {
    ...
    def download_file(
        self,
        request: Optional[Union[file_service.DownloadFileRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_download_file():
                ...
                # Make the request
                response = client.download_file(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.ai.generativelanguage_v1beta.types.DownloadFileRequest, dict]):
                The request object. Request for ``DownloadFile``.
            name (str):
        ...
        Returns:
            google.ai.generativelanguage_v1beta.types.DownloadFileResponse:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, file_service.DownloadFileRequest):
            request = file_service.DownloadFileRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.download_file]
