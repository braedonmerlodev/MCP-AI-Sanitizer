...
def native_non_extension_to_narwhals_dtype(
    dtype: pa.DataType, version: Version
...
def parse_datetime_format(arr: ChunkedArrayAny) -> str:
    ...
    matches = _extract_regex_concat_arrays(
        arr.drop_null().slice(0, 10), pattern=FULL_RE
    )
