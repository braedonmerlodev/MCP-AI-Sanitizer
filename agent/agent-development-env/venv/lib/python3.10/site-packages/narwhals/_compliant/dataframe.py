...
_ToDict: TypeAlias = (
    "dict[str, CompliantSeriesT] | dict[str, list[Any]]"  # noqa: PYI047
)
...
class CompliantFrame(
    ...
    @classmethod
    def from_native(
        cls, data: _NativeFrameT, /, *, context: _LimitedContext
    ) -> Self: ...
    @property
...
class CompliantDataFrame(
    ...
    @classmethod
    def from_arrow(
        cls, data: IntoArrowTable, /, *, context: _LimitedContext
    ) -> Self: ...
    @classmethod
    def from_dict(
        cls,
...
class EagerDataFrame(
    ...
    def _evaluate_exprs(self, *exprs: EagerExprT) -> Sequence[EagerSeriesT]:
        ...
        #  Type "EagerExprT@EagerDataFrame" is not assignable to type "EagerExprT@EagerDataFrame"
        return tuple(
            chain.from_iterable(self._evaluate_expr(expr) for expr in exprs)
