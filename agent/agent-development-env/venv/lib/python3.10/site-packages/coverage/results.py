...
class AnalysisNarrower:
    ...
    def __init__(self, analysis: Analysis) -> None:
        ...
        self.region2arc_possibilities: dict[TRegionLines, set[TArc]] = (
            collections.defaultdict(set)
        )
        self.region2arc_executed: dict[TRegionLines, set[TArc]] = (
            collections.defaultdict(set)
        )
        self.region2exit_counts: dict[TRegionLines, dict[TLineNo, int]] = (
    ...
    def add_regions(self, liness: Iterable[set[TLineNo]]) -> None:
        ...
        if self.analysis.has_arcs:
            ...
            collect_arcs(
                self.analysis.arc_possibilities_set, self.region2arc_possibilities
            )
