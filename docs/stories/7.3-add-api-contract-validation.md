...
- Endpoints to validate: /health, /documents/upload, /webhook/n8n, /trust-tokens/validate [Source: architecture/rest-api-spec.md]
...
- ✅ AC4: Contract validation covers all major API endpoints - /health, /webhook/n8n, /documents/upload, /trust-tokens/validate all covered
